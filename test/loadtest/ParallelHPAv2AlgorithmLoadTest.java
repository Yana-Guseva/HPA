...
public class ParallelHPAv2AlgorithmLoadTest extends HPALoadTest {
	
	private final int NUMBER_HANDLERS = 2;

	@Test
	public void testParallelHPAv2AlgorithmLoadTest() {
		System.out.println("----- ParallelHPAv2Algorithm (" + NUMBER_HANDLERS + ")-------");
